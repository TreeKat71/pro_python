...
EOF
wget -q -O - http://archive.cloudera.com/cdh5/ubuntu/trusty/amd64/cdh/archive.key | apt-key add -
...
apt-get install -y hadoop-conf-pseudo curl vim tmux libyaml-dev jq git
